...
class AboutUsPolicy
{
    ...
    {
        return $user->checkPermissionTo('create AboutUs');
    }
    ...
    {
        return $user->checkPermissionTo('update AboutUs');
    }
    ...
    {
        return $user->checkPermissionTo('delete AboutUs');
    }
    ...
    {
        return $user->checkPermissionTo('replicate AboutUs');
    }
