<section id="popup-share-team"
    ...
    <div class="inner w-full">
        ...
        <div class="info-wrapper bg-[#F2F8FD] px-11 2xl:px-10 xl:px-8 lg:px-6 py-6 flex items-center gap-7">
            <div class="image aspect-[3/4] overflow-hidden isolate rounded-3 max-w-[120px] w-full"><img class="full-cover"
                    src="{{ $user->media->first()?->original_url }} " alt="" loading="lazy"></div>
            <div class="naming">
        ...
        <div class="copy-wrapper px-11 2xl:px-10 xl:px-8 lg:px-6 pb-11 2xl:pb-10 xl:pb-8 lg:pb-6 pt-6 bg-[#F2F8FD]">
            ...
            <div
                ...
                <div class="link w-[calc(100%-72px)] text-3.5 font-medium text-tertiary-950"><span class="line-clamp-1">
